        ...
        >
          <Container>
            <div className="content-container">
              <div className="-title">
                <h2 className="titulo-48-bold">Políticas de Privacidade</h2>
              </div>

              <div className="inside-text paragraph-18-medium">
                <p>
                  A sua privacidade é importante para nós. É política do
                  respeitar a sua privacidade em relação a qualquer informação
                  sua que possamos coletar no site , e outros sites que
                  ...
                  <br />O uso continuado de nosso site será considerado como
                ...
                <p>
                  ...
                  Infelizmente, na maioria dos casos, não existem opções padrão
                  do setor para desativar os cookies sem desativar completamente
                  a funcionalidade e os recursos que eles adicionam a este site.
                ...
                <ul>
                  <li>
                    ...
                    connosco, usaremos cookies para o gerenciamento do processo
                  ...
                  <li>
                    ...
                    contato ou nos formulários de comentários, os cookies podem
                ...
                <p>
                  ...
                  permitem analisar nossos custos de publicidade e produtos para
                ...
                <p>
                  ...
                  da informação que o oferece no site e com caráter enunciativo,
                  mas não limitativo:
                </p>
                ...
                <p>
                  ...
                  xenofóbica, ou sobre cassinos, apostas desportivas (ex.: ),
                ...
                <p>
                  ...
                  nosso site.
                  <br />
                  Esta política é efetiva a partir de Março/2021.
                </p>
              </div>
            </div>
          </Container>
